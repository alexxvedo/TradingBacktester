...
export namespace Prisma {
  ...
  */
  ...
  export interface historicalDataDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * const historicalDataWithTimestampOnly = await prisma.historicalData.findMany({ select: { timestamp: true } })
     * 
     */
  ...
  interface historicalDataFieldRefs {
    readonly timestamp: FieldRef<"historicalData", 'DateTime'>
    readonly currency: FieldRef<"historicalData", 'String'>
    ...
    readonly interval: FieldRef<"historicalData", 'String'>
  }
  ...
  export type historicalDataWhereInput = {
    ...
    timestamp?: DateTimeFilter<"historicalData"> | Date | string
    currency?: StringFilter<"historicalData"> | string
    ...
    interval?: StringFilter<"historicalData"> | string
  }
  ...
  export type historicalDataWhereUniqueInput = Prisma.AtLeast<{
    timestamp_currency_interval?: historicalDataTimestampCurrencyIntervalCompoundUniqueInput
    AND?: historicalDataWhereInput | historicalDataWhereInput[]
    OR?: historicalDataWhereInput[]
    NOT?: historicalDataWhereInput | historicalDataWhereInput[]
    timestamp?: DateTimeFilter<"historicalData"> | Date | string
  ...
  export type historicalDataScalarWhereWithAggregatesInput = {
    ...
    timestamp?: DateTimeWithAggregatesFilter<"historicalData"> | Date | string
    currency?: StringWithAggregatesFilter<"historicalData"> | string
    ...
    interval?: StringWithAggregatesFilter<"historicalData"> | string
  }
  ...
  export type historicalDataTimestampCurrencyIntervalCompoundUniqueInput = {
    timestamp: Date | string
    currency: string
    interval: string
  }
